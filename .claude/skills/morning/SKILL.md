...
2. **Calendar** — Run the `/calendar` skill to get today's schedule from Google Calendar. This uses the Google Calendar MCP (`list_calendars` + `list_events`) to fetch events directly.
